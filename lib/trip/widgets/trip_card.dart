...
class TripDriverCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isSearching = trip.status == TripStatus.searching;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: isSearching ? const Color(0xFFFDE68A) : AppColors.border,
          width: 1.2,
        ),
        boxShadow: const [
          BoxShadow(
          ...
          ? Row(
              ...
              children: [
                Container(
                  ...
                  height: 48,
                  decoration: BoxDecoration(
                    color: AppColors.statusSearchingBg,
                  ...
                  child: const Center(
                    child: SizedBox(
                      ...
                      child: CircularProgressIndicator(
                        strokeWidth: 2.2,
                        valueColor: AlwaysStoppedAnimation<Color>(AppColors.statusSearching),
                      ),
                    ),
                  ),
                ),
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2),
                      Text(
                        'A ligar ao motorista mais próximo',
                        style: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w500,
                          color: AppColors.textSecondary,
    ...
    return Container(
      ...
      child: const Text(
        ...
        style: TextStyle(
          fontSize: 9,
          fontWeight: FontWeight.w700,
          color: AppColors.statusSearchingText,
        ),
      ),
    );
  }
